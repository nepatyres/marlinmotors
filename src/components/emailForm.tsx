    ...
    return (
        <div className="w-full lg:w-[42%]">
            <div className="font-ubuntuL text-white">
                <span className={`flex justify-center mt-[50px] sm:mb-2.5 text-white/90 tracking-wider text-[22px] sm:text-[30px] uppercase ${language ? 'font-gruppo font-semibold' : 'ubuntuL font-medium'}`}>{language ? 'Paskambinkite Mums' : 'позвоните нам'}</span>
            ...
            <div className="font-ubuntuL text-white w-full">
                <span className={`flex justify-center mt-[30px] mb-2.5 text-white/90 tracking-wider text-[22px] sm:text-[30px] uppercase ${language ? 'font-gruppo font-semibold' : 'ubuntuL font-medium'}`}>{language ? 'Parašykite mums' : 'напишите нам'}</span>
