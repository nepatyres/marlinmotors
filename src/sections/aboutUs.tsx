        ...
        <div id='scrollToAboutUs' className="h-auto pb-10 sm:pb-20 xl:pb-20 overflow-hidden bg-gradient-to-b from-[#141414] to-black">
            <div className="flex-row lg:flex-row w-[90%] mx-auto grid grid-cols-12">
                <div className="aboutus-main xl:col-span-7 col-span-12">
                    <span className="flex justify-center text-[30px] sm:text-[40px] font-semibold font-gruppo uppercase text-white/80 pt-20">Apie mus</span>
                    <p className='items-center justify-center font-ubuntuL w-full mx-auto text-white/70 mt-6 sm:mt-10 xl:pr-[30px] text-[20px] xl:text-[30px] pl-4 sm:pl-[30px] xl:pl-[0] xl:border-r xl:border-white/70'>Marlin Motors – vieta, kur rūpinamės Jūsų automobilio grožiu ir ilgaamžiškumu. Esame pasirengę pasirūpinti kiekvienu transporto tipu – nuo lengvųjų automobilių iki jūrų transporto. Siūlome aukščiausios kokybės paslaugas, kurios ne tik išryškina Jūsų transporto priemonės estetiką, bet ir užtikrina ilgalaikę apsaugą bei vertės išlaikymą.</p>
                </div>
                <div className="aboutus-ourvalues xl:pl-[30px] xl:col-span-5 col-span-12 xl:pb-[50px]">
                    <span className="flex justify-center text-[30px] sm:text-[40px] font-semibold font-gruppo uppercase text-white/80 pt-20 mb-6 xl:pb-[30px]">Mūsų vertybės</span>
                    {aboutUs.map((about, i) => (
